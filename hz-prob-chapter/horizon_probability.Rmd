...
kable(hz.eval$stats, col.names = c('GHL', 'Clay (%)', 'Horizon Mid-Point (cm)', 'Total RF Volume (%)', 'Moist Munsell Value', 'Sillhouette Width'), caption='Table 1. Evaluation of GHL via field-described soil properties. Reported values are means and standard deviation, in parenthesis. Values marked as "NA" are the result of missing or insufficient data.')
```
...
|Term       |Coef   |S.E.   |Wald Z |
|:----------|:------|:------|:------|
|y>=A       |2.2050 |0.2008  |10.98 |
|y>=BA     |-1.6688 |0.1020 |-16.36 |
|y>=Bt1    |-2.3032 |0.1064 |-21.66 |
|y>=Bt2    |-6.4802 |0.1961 |-33.04 |
|y>=Bt3   |-10.5553 |0.2542 |-41.52 |
|y>=Cr    |-13.0341 |0.2656 |-49.08 |
|y>=R     |-15.9055 |0.2785 |-57.12 |
|hzdept     |0.2513 |0.0077 |32.78  |
|hzdept'   |-0.3356 |0.0304 |-11.03 |
|hzdept''   |0.6957 |0.0806   |8.63 |
