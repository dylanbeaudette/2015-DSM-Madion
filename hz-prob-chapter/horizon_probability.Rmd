...
xyplot(PO.logistic.regression ~ empirical.probabilities | variable, data=g.wide, as.table=TRUE, xlab='Empirical GHL Probability', ylab='PO-LR Predictions', asp='iso') + latticeExtra::layer(panel.abline(a=0, b=1))
```
