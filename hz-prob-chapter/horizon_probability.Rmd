...
```{r slice-and-fit-1, echo=FALSE, fig.width=10, fig.height=6, fig.cap='Figure 2. Demonstration of some Loafercreek soil profiles sliced into 1-cm chunks, colored by GHL, and associated probability estimates from the fitted PO-LR model.'}
