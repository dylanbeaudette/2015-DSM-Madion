...
The expert's experience is (mostly) preserved within the REGEX rules.
However, there are usually cases where pattern matching along is not enough and manual adjustment of GHL on a horizon-by-horizon basis are needed.
