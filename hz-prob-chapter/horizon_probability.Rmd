...
```{r fig-model-residuals-by-genhz, fig.width=10, fig.height=5, echo=FALSE, fig.cap = 'CAPTION ME'}
...
```{r fig-model-fit-by-genhz, fig.width=10, fig.height=7, echo=FALSE, fig.cap = 'Does this help at all?'}
xyplot(PO.logistic.regression ~ empirical.probabilities | variable, data=g.wide, as.table=TRUE, xlab='Empirical GHL Probability', ylab='PO-LR Predictions') + latticeExtra::layer(panel.abline(a=0, b=1))
```
