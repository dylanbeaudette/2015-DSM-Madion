...
```{r generalization, echo=FALSE, results='hide'}
...
The Official Series Description (OSD, [REFERENCE]) of the Loafercreek series typical pedon and range in characteristics defines this soil series concept. 
